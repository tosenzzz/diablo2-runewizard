...
<U>+30 To All Attributes</U>
  ...
  All Resistances +10
  Cannot be Frozen
  `},ru=We({name:"RunewordPopup",data(){return{isVisible:!1,position:{x:0,y:0},runeword:{title:"",ttypes:[],level:0}}},computed:{formatBody(){const e=this.runeword.title;let t=e&&su[e]||"---";return t=t.trim(),t=t.replace(/\+?[0-9]+(-[0-9]+)?%?/g,'<span class="is-mod">$&</span>'),t=t.replace(/####\s(.*)\n+/g,'<h4 class="is-title">$1</h4>'),t=t.replace(/\n/g,"<br/>"),t}},methods:{unitPx(e){return`${e}px`},moveTo(e){let{x:n,y:s}=e.getBoundingClientRect();n=n+50,s=s+window.pageYOffset+e.offsetHeight+4;const o=this.$refs.root.offsetHeight,i=s+o,l=document.documentElement.clientHeight;let c=window.scrollY+l;c-=10,i>c&&(s=c-o,s=Math.max(window.scrollY+10,s)),this.position={x:n,y:s}},showRuneword(e,t){this.runeword=e,this.$nextTick(()=>{this.moveTo(t),this.isVisible=!0})},setVisible(e){this.isVisible=e}}}),ou={class:"rw-RunewordPopup-title"},iu=["innerHTML"],lu=["innerHTML"];function au(e,t,n,s,r,o){return F(),I("div",{ref:"root",class:"rw-RunewordPopup absolute",style:_t({visibility:e.isVisible?"visible":"hidden",left:e.unitPx(e.position.x),top:e.unitPx(e.position.y)}),onClick:t[0]||(t[0]=i=>e.setVisible(!1))},[_("h3",ou,se(e.runeword.title),1),_("div",{class:"rw-RunewordPopup-type",innerHTML:e.runeword.ttypes},null,8,iu),_("div",{class:"rw-RunewordPopup-body",innerHTML:e.formatBody},null,8,lu)],4)}const cu=de(ru,[["render",au]]),uu=We({name:"RunewordsTable",components:{IconArrowDown:Uc,IconArrowUp:Bc,IconCancel:yo,IconCheckOn:Yc,IconCheckOff:nu,RunewordPopup:cu},props:{items:{type:Array,required:!0}},data(){return{haveRunes:re.state.haveRunes,pinnedRunewords:re.state.pinned,sortKey:"level",sortAsc:!0,tableHeads:[{key:"title",label:"Runeword",textLeft:!0},{key:"rune0",label:"Rune"},{key:"rune1",label:"Rune"},{key:"rune2",label:"Rune"},{key:"rune3",label:"Rune"},{key:"rune4",label:"Rune"},{key:"rune5",label:"Rune"},{key:"ttypes",label:"Item Types"},{key:"level",label:"Level"}],envGameVersion:"2.6"}},computed:{runewordIsComplete(){const e=new Map;return this.items.forEach(t=>{e.set(t.title,t.runes.every(n=>this.haveRunes[n]))}),e},runesData(){const e=new Map;return An.forEach(t=>{e.set(t.name,t)}),e},itemsBySort(){const e=this.items.slice();let t;if(this.sortKey==="title")t=({title:r},{title:o})=>r===o?0:r>o?1:-1;else if(this.sortKey==="level")t=({level:r},{level:o})=>r===o?0:r>o?1:-1;else if(this.sortKey==="ttypes")t=({ttypes:r},{ttypes:o})=>r[0]===o[0]?0:r[0]>o[0]?1:-1;else if(/rune(\d)/.test(this.sortKey)){const r=parseInt(RegExp.$1);t=({runes:o},{runes:i})=>{const l=o[r],c=i[r];return l===c?0:l>c?1:-1}}t&&e.sort(t),!this.sortAsc&&e.reverse();const n=[...e.filter(r=>this.runewordIsComplete.get(r.title)),...e.filter(r=>!this.runewordIsComplete.get(r.title))];return[...n.filter(r=>this.pinnedRunewords.has(r.title)),...n.filter(r=>!this.pinnedRunewords.has(r.title))]},refPopup(){return this.$refs.popup}},methods:{cssActiveRune(e){return this.haveRunes[e]?"is-active":""},isActiveRuneWord(e){if(!re.state.hideIfNotHave)return!0;const t=Object.keys(this.haveRunes).filter(n=>this.haveRunes[n]);return t.length==0||t.some(n=>e.runes.includes(n))},cssCompleteRuneword(e){return this.runewordIsComplete.get(e.title)?"is-complete":""},getTypeCellHtml(e){let t=e.ttypes.map(n=>{const s=n.replace(" ","&nbsp;");return hr[n].url?`<a href="${hr[n].url}" target="_blank">${s}</a>`:s}).join("&nbsp;/&nbsp;");return e.tinfos&&(t+=`<br><span class="rw-Table-tdTypeClass">${e.tinfos}</span>`),t},isSortKey(e){return e===this.sortKey},onEnterRuneword(e,t){e.target&&this.refPopup.showRuneword(t,e.target)},onLeaveRuneword(){this.refPopup.setVisible(!1)},onSortBy(e){this.sortAsc=this.sortKey===e?!this.sortAsc:!0,this.sortKey=e},onTogglePin(e){const t=re.isPinned(e);re.setPinned([e],!t),re.saveState()},unpinAll(){const e=re.getPinned();re.setPinned(e,!1),re.saveState()}}}),fu={class:"rw-Table w-full"},du=["onClick"],hu={key:0,class:"rw-Table-thIcon"},pu={key:1,class:"rw-Table-thIcon"},mu={key:0,class:"rw-Table-tr"},gu={class:"rw-Table-td",colspan:"9"},vu={class:"text-center mt-6 py-2 relative"},yu=_("span",{class:"text-md text-gold tracking-[.2em]"},"PINNED RUNEWORDS",-1),Tu={key:1,class:"rw-Table-tr"},Cu=_("td",{class:"rw-Table-td",colspan:"9"},[_("div",{class:"text-center text-md text-gold tracking-[.2em] mt-6 py-2"},"ALL RUNEWORDS")],-1),_u=[Cu],Su={class:"rw-Table-td rw-Table-tdTitle p-0 text-left relative min-w-[10em]"},Au=["onMouseenter","onClick"],bu={key:0,class:"rw-Md-ladder",title:"Ladder Only"},Ru=["onClick"],wu=["onClick"],Lu=["innerHTML"],Du={class:"rw-Table-td"};function Eu(e,t,n,s,r,o){const i=ue("runeword-popup"),l=ue("icon-arrow-down"),c=ue("icon-arrow-up"),f=ue("icon-cancel"),d=ue("icon-check-on"),m=ue("icon-check-off");return F(),I(le,null,[N(i,{ref:"popup"},null,512),_("table",fu,[_("thead",null,[_("tr",null,[(F(!0),I(le,null,It(e.tableHeads,p=>(F(),I("th",{key:p.key,class:Te(["rw-Table-th cursor-pointer",{"is-sortCol":e.isSortKey(p.key),"text-left":p.textLeft}]),onClick:R=>e.onSortBy(p.key)},[pt(se(p.label)+" ",1),e.isSortKey(p.key)&&e.sortAsc?(F(),I("span",hu,[N(l,{class:"ux-icon ux-icon--fw"})])):Ie("",!0),e.isSortKey(p.key)&&!e.sortAsc?(F(),I("span",pu,[N(c,{class:"ux-icon ux-icon--fw"})])):Ie("",!0)],10,du))),128))])]),_("tbody",null,[(F(!0),I(le,null,It(e.itemsBySort,(p,R)=>{var B,O,ee,G,Y,V;return F(),I(le,{key:R},[e.pinnedRunewords.size&&R===0?(F(),I("tr",mu,[_("td",gu,[_("div",vu,[yu,_("a",{class:"rw-Runes-clear absolute right-0 top-1",href:"#",onClick:t[0]||(t[0]=gs((...$)=>e.unpinAll&&e.unpinAll(...$),["prevent"]))},[N(f,{class:"ux-icon ux-icon--fw rw-Runes-clearIcon text-[#da0000] mr-1"}),pt("unpin all ")])])])])):Ie("",!0),e.pinnedRunewords.size&&R===e.pinnedRunewords.size?(F(),I("tr",Tu,_u)):Ie("",!0),_("tr",{class:Te(["rw-Table-tr",e.cssCompleteRuneword(p)]),style:_t({display:p.filterMatch&&e.isActiveRuneWord(p)?"":"none"})},[_("td",Su,[_("span",{class:"rw-Table-tdTitleSpan cursor-pointer",onMouseenter:$=>e.onEnterRuneword($,p),onMouseleave:t[1]||(t[1]=$=>e.onLeaveRuneword()),onClick:$=>e.onEnterRuneword($,p)},se(p.title),41,Au),p.ladder?(F(),I("span",bu,"L")):Ie("",!0),p.version?(F(),I("span",{key:1,class:Te(["rw-Table-tdTitlePatch",{"is-new":p.version===e.envGameVersion}]),title:"Patch version"},se(p.version),3)):Ie("",!0),e.pinnedRunewords.has(p.title)?(F(),I("div",{key:2,class:"rw-Table-pin is-pinned",onClick:$=>e.onTogglePin(p.title)},[N(d,{class:"rw-Table-pinIcon"})],8,Ru)):(F(),I("div",{key:3,class:"rw-Table-pin",onClick:$=>e.onTogglePin(p.title)},[N(m,{class:"rw-Table-pinIcon"})],8,wu))]),_("td",{class:Te(["rw-Table-td is-rune",e.cssActiveRune(p.runes[0])])},se((B=e.runesData.get(p.runes[0]))==null?void 0:B.fname),3),_("td",{class:Te(["rw-Table-td is-rune",e.cssActiveRune(p.runes[1])])},se((O=e.runesData.get(p.runes[1]))==null?void 0:O.fname),3),_("td",{class:Te(["rw-Table-td is-rune",e.cssActiveRune(p.runes[2])])},se((ee=e.runesData.get(p.runes[2]))==null?void 0:ee.fname),3),_("td",{class:Te(["rw-Table-td is-rune",e.cssActiveRune(p.runes[3])])},se((G=e.runesData.get(p.runes[3]))==null?void 0:G.fname),3),_("td",{class:Te(["rw-Table-td is-rune",e.cssActiveRune(p.runes[4])])},se((Y=e.runesData.get(p.runes[4]))==null?void 0:Y.fname),3),_("td",{class:Te(["rw-Table-td is-rune",e.cssActiveRune(p.runes[5])])},se((V=e.runesData.get(p.runes[5]))==null?void 0:V.fname),3),_("td",{class:"rw-Table-td rw-Table-tdType min-w-[10em]",innerHTML:e.getTypeCellHtml(p)},null,8,Lu),_("td",Du,se(p.level),1)],6)],64)}),128))])])],64)}const Mu=de(uu,[["render",Eu]]),xu=We({name:"Runewords",components:{RunewordsTable:Mu},data(){return{isHelpVisible:!1,runewordsList:[],searchText:"",version:"LOD"}},computed:{VerList(){let e=Object.keys(Hn);return e.push("ALL"),e},Vers(){return Hn[this.version]}},created(){this.runewordsList=kc.slice(),this.updateFilter(this.searchText,this.version)},methods:{onSearchInput(){this.updateFilter(this.searchText,this.version)},updateFilter(e,t){const n=Hn[t]||[],s=e.toLowerCase(),r=o=>{const i=o.title.toLowerCase().includes(s),l=o.ttypes.some(f=>f.toLowerCase().includes(s)),c=n.includes(o.version||"");return(t=="ALL"||c)&&(s===""||i||l)};this.runewordsList.forEach(o=>{o.filterMatch=r(o)})}}}),ku={class:"rw-Search flex items-center mb-8"},Fu=_("label",{class:"text-gold whitespace-nowrap mr-4"},se("Search"),-1),Iu=_("span",{class:"mr-4"},null,-1),Ou=_("label",{class:"text-gold whitespace-nowrap"},se("Version"),-1),Hu=["value"];function Pu(e,t,n,s,r,o){const i=ue("runewords-table");return F(),I("div",null,[_("div",ku,[Fu,Hs(_("input",{"onUpdate:modelValue":t[0]||(t[0]=l=>e.searchText=l),type:"text",class:"rw-Search-input",onInput:t[1]||(t[1]=(...l)=>e.onSearchInput&&e.onSearchInput(...l))},null,544),[[Jl,e.searchText]]),Iu,Ou,Hs(_("select",{"onUpdate:modelValue":t[2]||(t[2]=l=>e.version=l),class:"rw-Search-select",onChange:t[3]||(t[3]=(...l)=>e.onSearchInput&&e.onSearchInput(...l))},[(F(!0),I(le,null,It(e.VerList,l=>(F(),I("option",{key:l,value:l},se(l),9,Hu))),128))],544),[[Yl,e.version]])]),_("div",null,[N(i,{items:e.runewordsList},null,8,["items"])])])}const Bu=de(xu,[["render",Pu]]),$u=We({name:"App",components:{AppHeader:qa,AppFooter:lc,Runes:xc,Runewords:Bu},computed:{useLayoutHeader(){return!0}}}),Vu={class:"rw-Layout-rowContainer rw-Main py-4 flex mb-24"},Wu={class:"mr-16"},Nu={class:"overflow-auto flex-1"};function Ku(e,t,n,s,r,o){const i=ue("app-header"),l=ue("runes"),c=ue("runewords"),f=ue("app-footer");return F(),I(le,null,[e.useLayoutHeader?(F(),ho(i,{key:0})):Ie("",!0),_("main",Vu,[_("div",Wu,[N(l)]),_("div",Nu,[N(c)])]),N(f)],64)}const Uu=de($u,[["render",Ku]]),qu=()=>{re.initialize(),re.loadState()};qu();ta(Uu).mount("#app");
